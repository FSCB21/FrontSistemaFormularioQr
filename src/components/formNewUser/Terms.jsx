  ...
  return (
    <div>
        <Accordion className="accordion-custom" activeIndex={0}>
                ...
                <AccordionTab header={<React.Fragment><RiFileUserLine/><span className='text-xs'> Información De Los Usuarios</span></React.Fragment>}>
                    <p className='text-xs'>
                ...
                <AccordionTab header={<React.Fragment><FiDatabase/><span className='text-xs'> Almacenamiento De La Información</span></React.Fragment>}>
                    <p className='text-xs'>
                ...
                <AccordionTab header={<React.Fragment><RiShieldLine /><span className='text-xs'> Seguridad Del Dispositivo</span></React.Fragment>}>
                    <p className='text-xs'>
                ...
                <AccordionTab header={<React.Fragment><BsCreditCard /><span className='text-xs'> Datos De Cobro</span></React.Fragment>}>
                    <p className='text-xs'>
                ...
                <AccordionTab header={<React.Fragment><FaUserTimes /><span className='text-xs'> Identidad Del Usuario</span></React.Fragment>}>
                    <p className='text-xs'>
                ...
                <AccordionTab header={<React.Fragment><GoBook /><span className='text-xs'> Sobre Habeas Data</span></React.Fragment>}>
                    <p className='text-xs'>
                ...
                <AccordionTab header={<React.Fragment><RiSearchEyeLine /><span className='text-xs'> Términos Y Condiciones De Uso</span></React.Fragment>}>
                    <p className='text-xs'>
                        ...
                        <a href="https://www.fxa.com.co/8209-2/" > ver mas.</a>
                    </p>
                </AccordionTab>
                <AccordionTab header={<React.Fragment><BsTelephone/><span className='text-xs'> Solicitudes</span></React.Fragment>}>
                    <p className='text-xs'>
                        Para efectos de recibir las peticiones, reclamaciones y consultas relacionadas con el manejo y tratamiento de datos personales, FXA ha destinado el correo electrónico <b>servicioalcliente@fuxiaaccesorios.com</b>, para canalizarlas, estudiarlas y contestarlas.
                    </p>
                </AccordionTab>
            </Accordion>
    </div>
